import configModule from '/Users/asahel/Documents/Web/Svelte5/test-async-store-indexeddb/path/to/dexie-worker.config.js';
const configs = configModule.default || configModule;

importScripts('https://cdn.jsdelivr.net/npm/dexie@4.0.11/dist/dexie.min.js');
  var db = null;
